import{il as A,ab as M,H as at,iN as Ne,ip as le,ln as ee,ot as rt,nw as ce,ou as st,io as lt,iq as ct,is as ft,ir as ut,ik as k,mB as dt,eP as _t,hb as vt,ov as ht,af as H,b1 as ge,ow as mt,bG as oe,le as Fe,ox as pt,oy as gt,oz as yt,oA as xt,v as ve,dp as St,dr as Tt,ai as It,oB as N,oC as Be,it as ye,bo as bt,bn as Et,oD as xe,f as Ue,iP as Ot,fP as Se,dB as At,oE as Pt}from"./index-3wvgNpRK.js";import{$ as Mt,d as Te,f as Ct,g as Ye,s as z,t as Lt,n as X,e as q,h as Ge}from"./Utils-BccyNt0v.js";import{e as zt,a as te}from"./ProgramTemplate-BX9eM0dH.js";import{h as $}from"./VertexArrayObject-DnLhPDkq.js";import{n as Dt}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as ne}from"./VertexElementDescriptor-BLyltQyJ.js";import{r as j}from"./VertexBuffer-DY6KYC17.js";import{n as Rt}from"./vec3f32-WCVSSNPR.js";import{e as He,n as wt}from"./Container-DoaQ6Mnp.js";import{n as Vt}from"./memoryEstimations-CxGllILD.js";import{o as fe}from"./BufferObject--ZPnoaH1.js";import{e as Ie}from"./config-BOD8--da.js";import{e as Nt}from"./earcut-D9gy186-.js";import{t as Ft,X as Bt}from"./featureConversionUtils-DhnAtXfZ.js";import{e as be}from"./OptimizedFeature-B1Jvvzh6.js";function ke(){return new Float32Array(4)}function Ut(f){const e=new Float32Array(4);return e[0]=f[0],e[1]=f[1],e[2]=f[2],e[3]=f[3],e}function B(f,e,t,n){const i=new Float32Array(4);return i[0]=f,i[1]=e,i[2]=t,i[3]=n,i}function $e(){return ke()}function We(){return B(1,1,1,1)}function Ze(){return B(1,0,0,0)}function je(){return B(0,1,0,0)}function Ke(){return B(0,0,1,0)}function qe(){return B(0,0,0,1)}const Yt=$e(),Gt=We(),Ht=Ze(),kt=je(),$t=Ke(),Wt=qe();Object.freeze(Object.defineProperty({__proto__:null,ONES:Gt,UNIT_W:Wt,UNIT_X:Ht,UNIT_Y:kt,UNIT_Z:$t,ZEROS:Yt,clone:Ut,create:ke,fromValues:B,ones:We,unitW:qe,unitX:Ze,unitY:je,unitZ:Ke,zeros:$e},Symbol.toStringTag,{value:"Module"}));let U=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const Zt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {

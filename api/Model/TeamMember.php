...
class TeamMember
{
    ...
    public function createMember($data)
    {
        try {
            ...
            $stmt->bindParam(':phone_ext',     $data['phone_ext']     ?? null, PDO::PARAM_STR);
            $stmt->bindParam(':linkedin_url',  $data['linkedin_url']  ?? null, PDO::PARAM_STR);
            $stmt->bindParam(':image_url',     $data['image_url']     ?? null, PDO::PARAM_STR);
            $stmt->bindParam(':member_type',   $data['member_type'],   PDO::PARAM_STR);

              ...
              <div className="cms-wrapper">
                ...
                <section className="cms-modules">
                  ...
                  <div className="cms-modules-grid">
                    <div className="cms-module-card cms-module-card--highlight">
                      <img src={UsersIcon} className="cms-module-icon" alt="About Us Icon" />
                      <h3>Sobre Nosotros</h3>
                      <p>
                        Gestione el directorio de facultad y las listas de estudiantes.
                      </p>
                      <ul>
                        <li>Editar información de contacto de facultad</li>
                        <li>Actualizar listas de estudiantes graduados</li>
                        <li>Actualizar listas de subgraduados</li>
                      </ul>
                      <Link to="/cms/sobre-nosotros" className="cms-module-btn">Editar Directorio</Link>
                    </div>
                    ...
                    <div className="cms-module-card">
                      ...
                      <ul>
                        ...
                        <li>Ver estado de cada usuario</li>
                      </ul>
                ...
                <footer className="cms-footer">
                  Puerto Rico Landslide Hazard Mitigation Office · Derrumbe.net CMS · 2026
                </footer>
              </div>
            );
}
